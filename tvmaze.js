...
var DEFAULT_IMAGE_URL = "https://cdn.pixabay.com/photo/2022/11/19/09/35/forest-7601671_960_720.jpg";
var BASE_SHOW_API_URL = "http://api.tvmaze.com/search/shows";
var BASE_EPISODE_API_URL = "http://api.tvmaze.com/shows";
var $showsList = $("#showsList");
var $episodesArea = $("#episodesArea");
var $episodeList = $("#episodesList");
var $searchForm = $("#searchForm");
var $searchInput = $("#searchForm-term");
...
function getShowsByTerm(term) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, axios_1.default.get(BASE_SHOW_API_URL, { params: { q: term } })];
                case 1:
                    response = _a.sent();
...
function populateEpisodes(episodes) {
    ...
    for (var _i = 0, episodes_1 = episodes; _i < episodes_1.length; _i++) {
        ...
        var $episode = $("\n        <li>\n          <h5>".concat(episode.name, "</h5>\n          <p>Season: ").concat(episode.season, "</p>\n          <p>Episode: ").concat(episode.number, "</p>\n        </li>\n      "));
